...
colorscale = scale_fill_manual(values=c("#FEFECE", "#FDD181", 
    "#FFBD7F", "#FFA681", "#DA7957", "#BA5336", "#932D17", "#720000", "#EFFCFE"))

ggplot(world_map, aes(x = long, y = lat, group = group)) +
  geom_polygon(aes(fill=percent_set), colour = "black") + colorscale
