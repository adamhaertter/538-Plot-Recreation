...
colorscale = scale_fill_manual(values=c("olivedrab", "black", "darkblue", 
    "yellow", "pink", "red", "orange", "lightblue", "orchid","green", "tan", 
    "cyan", "darkgray", "purple", "magenta", "peru", "lightgray", "blue"))

ggplot(world_map, aes(x = long, y = lat, group = group)) +
  geom_polygon(aes(fill=percent_set), colour = "black") 
